...
def main(args):
    ...
    if threshold_iou_max > threshold_iou_min:
        threshold_iou = np.arange(start=threshold_iou_min, stop=threshold_iou_max+threshold_iou_step, step=threshold_iou_step)
    else:
    ...
    for fidx in gt.keys():
        ...
        data_performances = np.array([evaluation_utils.extract_performances(data_gt, data_p, iou_idx) for iou_idx in threshold_iou])[0]
        tp = data_performances[0]
        fp = data_performances[1]
        fn = data_performances[2]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--threshold_iou_min', required=False, default=0.4, type=float)
    parser.add_argument('--threshold_iou_max', required=False, default=0.75, type=float)
...
# python evaluate.py --input /home/temporal2/mvazquez/Challenge/evaluation_script/input --output /home/temporal2/mvazquez/Challenge/evaluation_script/output --threshold_iou_min 0.5 --threshold_iou_max 0.5 --threshold_iou_step 0
# python evaluate.py --input /home/temporal2/mvazquez/Challenge/evaluation_script/input --output /home/temporal2/mvazquez/Challenge/evaluation_script/output --threshold_iou_min 0.2 --threshold_iou_max 0.8 --threshold_iou_step 0.05
